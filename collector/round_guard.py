...
ข้อความอยู่ที่นี่ ไม่ใช่ใน scripts/toolkit.sh เพื่อให้ข้อความภาษาไทยทั้งหมดอยู่ที่เดียว
"""
...
# scripts/toolkit.sh เห็นรหัสนี้แล้วจะจบเงียบ ไม่ขึ้นให้ส่งหา maintainer
